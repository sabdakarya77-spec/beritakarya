...
import { GridBlockWrapper } from './GridBlockWrapper'
import { BlockRenderer } from './gridblock.registry'
import { FileText, Plus } from 'lucide-react'

export function GridBlockList() {
  ...
  return (
    <div className="space-y-0 pb-32">
      {blocks.map((block, idx) => (
        <GridBlockWrapper key={block.id} block={block} index={idx}>
