...
/**
 * Main editor entry point — the only component that should be imported
 * by page-level routes.
 *
 * Handles:
 * - Article loading/saving lifecycle
 * - Global keyboard shortcuts (Ctrl+S save, Ctrl+Z undo)
 * - Mode switching between GridBlock and WordPress
 *
 * Uses ArticleEditorShell as the layout wrapper and EditorCanvas
 * as the mode-aware content area.
 */
