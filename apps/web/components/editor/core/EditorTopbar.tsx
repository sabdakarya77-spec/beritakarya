/**
 * EditorTopbar — Shared topbar for the article editor.
 *
 * Displays:
 * - Save status and controls
 * - Mode switcher (GridBlock ↔ WordPress)
 * - Focus mode toggle
 * - Publish/submit workflow
 * - AI assistant and settings access
 *
 * This is the canonical implementation; the legacy `../EditorTopbar.tsx`
 * delegates here.
 */
'use client';
