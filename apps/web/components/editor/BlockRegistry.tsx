...
export function BlockRenderer({ block }: { block: Block }) {
  ...
  if (!Component) {
    return (
      <div className="group relative py-4 px-6 border-2 border-dashed border-gray-100 rounded-xl bg-gray-50/50 transition-all hover:bg-gray-50 hover:border-gray-200">
